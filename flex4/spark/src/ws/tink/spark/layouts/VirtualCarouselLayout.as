package ws.tink.spark.layouts
{
	 ...
	 */
	public class VirtualCarouselLayout extends PerspectiveAnimationNavigatorLayoutBase
	{
		 ...
		 *  @productversion Flex 4
		 */
		public function VirtualCarouselLayout()
		{
			super( INDIRECT );
...
import ws.tink.spark.layouts.VirtualCarouselLayout;
...
internal class TransformValues
{
	 ...
	 *  @productversion Flex 4
	 */
	public function TransformValues( layout:VirtualCarouselLayout )
	{
		_layout = layout;
	...
	private var _layout			: VirtualCarouselLayout;
...
//			{
				_an = _layout.numUnselectedElements ? _layout.angle / ( ( _layout.numUnselectedElements * 2 )  ) : _layout.angle;
